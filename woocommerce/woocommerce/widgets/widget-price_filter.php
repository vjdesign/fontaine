...
class WooCommerce_Widget_Price_Filter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo '<form id="priceslider" method="get" action="' . $form_action . '">
			<div class="price_slider_wrapper">
				<div class="price_slider" style="display:none;"></div>
				<div class="price_slider_amount">
					<input type="hidden" id="min_price" name="min_price" value="'.esc_attr( $post_min ).'" data-min="'.esc_attr( $min ).'" placeholder="'.__('Min price', 'woocommerce').'" />
					<input type="hidden" id="max_price" name="max_price" value="'.esc_attr( $post_max ).'" data-max="'.esc_attr( $max ).'" placeholder="'.__('Max price', 'woocommerce').'" />
					<div class="price_label" style="display:none;margin-top:5px;margin-bottom:5px;">
