...
class WC_Countries {
	...
	function get_country_locale() {
		if ( ! $this->locale ) {
			...
			$this->locale['default'] = apply_filters('woocommerce_get_country_locale_default', array(
				...
				'state'		=> array(
					'label' 		=> __('State/Territory', 'woocommerce'),
					'placeholder' 	=> __('State/Territory', 'woocommerce'),
					'required' 		=> true
				)
			));
	...
	function get_address_fields( $country, $type = 'billing_' ) {
		...
		$fields = array(
			...
			'company' 	=> array(
				'label' 		=> __('Company Name (if applicable)', 'woocommerce'),
				'placeholder' 	=> _x('Company Name (if applicable)', 'placeholder', 'woocommerce'),
				'clear'			=> true
				),
			'address_1' 	=> array(
			...
			'address_2' => array(
				'label' 		=> __('Street Name & Type', 'woocommerce'),
				'placeholder' 	=> _x('Street Name & Type', 'placeholder', 'woocommerce'),
				'required' 		=> true,
				'class' 		=> array('form-row-last'),
				'clear'			=> true
				),
