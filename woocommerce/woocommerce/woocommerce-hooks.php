...
//	add_action( 'woocommerce_after_single_product_summary', 'woocommerce_output_related_products', 20 );
	...
	add_action( 'woocommerce_single_product_summary', 'woocommerce_show_product_thumbnails', 13 );
...
//	add_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_add_to_cart', 30 );
	...
	add_action( 'woocommerce_product_tabs', 'woocommerce_product_reviews_tab', 20 );
	add_action( 'woocommerce_product_tabs', 'woocommerce_product_question_tab', 30 );

	add_action( 'woocommerce_product_tab_panels', 'woocommerce_product_attributes_panel', 10 );
	add_action( 'woocommerce_product_tab_panels', 'woocommerce_product_reviews_panel', 20 );
	add_action( 'woocommerce_product_tab_panels', 'woocommerce_product_question_panel', 30 );
	...
	add_action( 'woocommerce_related_products', 'woocommerce_related_products_display' );
