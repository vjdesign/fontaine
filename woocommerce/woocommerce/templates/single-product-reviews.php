...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	$comment_form = array(
		...
		'fields' => array(
			...
			'vercode'  => '<p class="comment-form-email"><label for="email">' . __( 'Enter Code', 'woocommerce' ) . '</label> ' . '<span class="required">* </span>' .
			            '<input id="vercode"  style="width:90px" name="vercode" type="text" value="' . esc_attr(  $commenter['comment_author_vercode'] ) . '" size="30" aria-required="true" /> &nbsp; <img src="http://fontaineind.com.au/captcha.php" /></p>',
		),
