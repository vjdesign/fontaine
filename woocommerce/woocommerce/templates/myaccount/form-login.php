...
<?php endif; ?>
		...
		<form method="post" class="login" style="height:160px;">
			...
			<p class="form-row" style="padding-top:10px;text-align:center;">
...
<?php if (get_option('woocommerce_enable_myaccount_registration')=='yes') : ?>
	...
	<div class="col-2" style="padding-top:10px;">
		...
		<form method="post" class="register" style="height:160px;">
