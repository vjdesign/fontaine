	...
	<tbody>
		...
		<tr>
			<td colspan="7" class="actions">
				...
				<?php } ?>
				<div id="updateqty" style="display:inline;cursor:pointer;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="button" name="update_cart" value="<?php _e('Update Cart', 'woocommerce'); ?>" /> <span id="proceedbutton"><input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e('Proceed to Checkout &rarr;', 'woocommerce'); ?>" /></span></div>
