	...
	<tbody>
		...
		<tr>
			<td colspan="7" class="actions">
				...
				<?php } ?>
				<div id="updateqty" style="display:inline;cursor:pointer;"><a class="button" href="<?php echo $woocommerce->cart->get_cart_url(); ?>?empty-cart"  id="emptycart" ><?php _e( 'Empty Cart', 'woocommerce' ); ?></a>&nbsp;<input type="submit" class="button" name="update_cart" value="<?php _e('Update Cart', 'woocommerce'); ?>" /> <span id="proceedbutton"><input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e('Proceed to Checkout &rarr;', 'woocommerce'); ?>" /></span></div>
...
<span id="proceedbutton1"><input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e('proceed to check out ', 'woocommerce'); ?>" /></span>
<span id="cshopping">continue shopping</span>
</form>
