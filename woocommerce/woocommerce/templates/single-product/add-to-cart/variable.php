		...
		<div id="innercart_contents">
						...
						<tbody>
							<?php $loop = 0; $cls1 = ""; foreach ( $attributes as $name => $options ) : $loop++; ?>
								<tr>
									...
									<td class="value"><select id="<?php echo esc_attr( sanitize_title($name) ); ?>" name="attribute_<?php echo sanitize_title($name); ?>" class="variation_sel" >
			...
			<div class="cart_qty hline1" style="float:left;">
				...
				<div class="qty_number">
					<div class="single_variation_wrap" style="padding-top:5px;">
