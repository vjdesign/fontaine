...
<?php if ( $woocommerce->cart->ship_to_billing_address_only() && $woocommerce->cart->needs_shipping() ) : ?>
	...
	<h3 class="dashed-line" style="margin-bottom:5px;"><?php _e('Billing &amp; Shipping', 'woocommerce'); ?></h3>

<?php else : ?>

	<h3 class="dashed-line" style="margin-bottom:5px;"><?php _e('Billing Address', 'woocommerce'); ?></h3>
