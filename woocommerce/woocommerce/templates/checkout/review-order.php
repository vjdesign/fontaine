...
<div id="order_review">
	...
	<table class="shop_table">
		...
		<tfoot>
			...
			<tr class="shipping" style="text-align:center;">
				<th colspan="2"><?php _e('Shipping', 'woocommerce'); ?></th>
				<td><label for="shipping_method_local_delivery"><span class="amount">
				<?php
						echo "&#36;" . $_SESSION['sval'];	
				?>
				</span></label>
				<ul id="shipping_method"><li><input type="radio" hidden name="shipping_method" id="shipping_method_local_delivery" value="local_delivery"  checked='checked' /></li></ul>
				</td>
					...
					if (sizeof($taxes)>0) :
						...
						if ($has_compound_tax && !$woocommerce->cart->prices_include_tax) :
							...
							<tr class="order-subtotal">
								<th colspan="2"><?php _e('Order Subtotal', 'woocommerce'); ?></th>
			...
			<tr class="total" style="text-align:center;">
				<th colspan="2" style=""><?php _e('Order Total', 'woocommerce'); ?></th>
	...
	<h3 class="dashed-line">Payment</h3>
