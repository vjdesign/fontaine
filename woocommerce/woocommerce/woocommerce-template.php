...
if ( ! function_exists( 'woocommerce_get_product_thumbnail' ) ) {
	...
	function woocommerce_get_product_thumbnail( $size = 'shop_catalog', $placeholder_width = 0, $placeholder_height = 0  ) {
		...
		if ( ! $placeholder_width )
			$placeholder_width = $woocommerce->get_image_size( 'shop_single_product_image_width' );
		if ( ! $placeholder_height )
			$placeholder_height = $woocommerce->get_image_size( 'shop_single_product_image_height' );

		if ( has_post_thumbnail() )
//			return get_the_post_thumbnail( $post->ID, $size );
			return get_the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) );
...
if ( ! function_exists( 'woocommerce_product_question_tab' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_product_question_tab() {
		woocommerce_get_template( 'single-product/tabs/tab-askQuestion.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_product_question_panel' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_product_question_panel() {
		woocommerce_get_template( 'single-product/tabs/question.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_related_products_display' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_related_products_display() {
		woocommerce_get_template( 'cart/related-products.php' );
	}
}
	...
	function woocommerce_product_subcategories_new( $args = array() ) {
		...
		if ( $product_categories ) {
			...
			foreach ( $product_categories as $category ) {
				...
				woocommerce_get_template( 'content-product_cat1.php', array(
					'category' => $category
				) );
...
if ( ! function_exists( 'woocommerce_product_subcategories1' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_product_subcategories1( $args = array() ) {
		global $woocommerce, $wp_query, $_chosen_attributes;
...
if ( ! function_exists( 'get_product_search_form' ) ) {
	...
	function get_product_search_form( $echo = true  ) {
		...
		$form = '<form role="search" method="get" id="searchform" action="' . esc_url( home_url( '/'  ) ) . '">
			<div id="searchinput">
				<label class="screen-reader-text" for="s">' . __( 'product search:', 'woocommerce' ) . '</label>
				<input type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="' . __( 'type product detail here', 'woocommerce' ) . '" />
			</div>
			<div id="searchicon">
				<input type="image" src="' . get_site_url() . '/wp-content/themes/fontaine/images/search_btn.png" id="searchsubmit" value="'. esc_attr__( 'Search' ) .'" />
