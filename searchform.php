...
<form method="get" id="searchform" action="<?php echo esc_url( home_url('/') ); ?>" >
	<label for="search" class="screen-reader"><?php _e( 'Search this site:', 'keel' ) ?></label>
	<input class="input-inline input-search no-margin-bottom" type="text" id="search" name="s" placeholder="<?php _e( 'Search: type product detail here...', 'keel' ) ?>" value="<?php the_search_query(); ?>">
